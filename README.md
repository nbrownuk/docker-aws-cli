...
- [`1.16.70`, `1.16`, `latest` *(1.16.70/Dockerfile)*](https://github.com/nbrownuk/docker-aws-cli/blob/master/Dockerfile)
...
```
$ docker image build --build-arg UID=2000 --build-arg VERSION="1.16.709" -t aws-cli
```
...
```
$ docker image build --build-arg VERSION="1.16.709" -t aws-cli
```
