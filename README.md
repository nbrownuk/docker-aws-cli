...
- [`1.12.0`, `1.12`, `latest` *(1.12.0/Dockerfile)*](https://github.com/nbrownuk/docker-aws-cli/blob/master/Dockerfile)
...
```
$ docker image build --build-arg UID=2000 --build-arg VERSION="1.12.69" -t aws-cli
```
...
```
$ docker image build --build-arg VERSION="1.12.69" -t aws-cli
```
