...
- [`1.13.0`, `1.13`, `latest` *(1.13.0/Dockerfile)*](https://github.com/nbrownuk/docker-aws-cli/blob/master/Dockerfile)
...
```
$ docker image build --build-arg UID=2000 --build-arg VERSION="1.13.69" -t aws-cli
```
...
```
$ docker image build --build-arg VERSION="1.13.69" -t aws-cli
```
