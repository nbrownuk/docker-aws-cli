...
- [`1.16.35`, `1.16`, `latest` *(1.16.35/Dockerfile)*](https://github.com/nbrownuk/docker-aws-cli/blob/master/Dockerfile)
...
```
$ docker image build --build-arg UID=2000 --build-arg VERSION="1.16.359" -t aws-cli
```
...
```
$ docker image build --build-arg VERSION="1.16.359" -t aws-cli
```
