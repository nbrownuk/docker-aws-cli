...
- [`1.15.66`, `1.15`, `latest` *(1.15.66/Dockerfile)*](https://github.com/nbrownuk/docker-aws-cli/blob/master/Dockerfile)
...
```
$ docker image build --build-arg UID=2000 --build-arg VERSION="1.15.669" -t aws-cli
```
...
```
$ docker image build --build-arg VERSION="1.15.669" -t aws-cli
```
