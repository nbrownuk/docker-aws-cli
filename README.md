...
- [`1.14.38`, `1.14`, `latest` *(1.14.38/Dockerfile)*](https://github.com/nbrownuk/docker-aws-cli/blob/master/Dockerfile)
...
```
$ docker image build --build-arg UID=2000 --build-arg VERSION="1.14.389" -t aws-cli
```
...
```
$ docker image build --build-arg VERSION="1.14.389" -t aws-cli
```
