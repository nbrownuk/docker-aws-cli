...
- [`1.14.54`, `1.14`, `latest` *(1.14.54/Dockerfile)*](https://github.com/nbrownuk/docker-aws-cli/blob/master/Dockerfile)
...
```
$ docker image build --build-arg UID=2000 --build-arg VERSION="1.14.549" -t aws-cli
```
...
```
$ docker image build --build-arg VERSION="1.14.549" -t aws-cli
```
