...
- [`1.14.65`, `1.14`, `latest` *(1.14.65/Dockerfile)*](https://github.com/nbrownuk/docker-aws-cli/blob/master/Dockerfile)
...
```
$ docker image build --build-arg UID=2000 --build-arg VERSION="1.14.659" -t aws-cli
```
...
```
$ docker image build --build-arg VERSION="1.14.659" -t aws-cli
```
